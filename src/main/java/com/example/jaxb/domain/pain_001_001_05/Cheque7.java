...
public class Cheque7 implements ToString2
{
    ...
    public void setMemoFld(List<String> value) {
        this.memoFld = value;
    }

    public void setSgntr(List<String> value) {
        this.sgntr = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "chqTp", buffer, theChqTp, (this.chqTp!= null));
        }
        {
            String theChqNb;
            theChqNb = this.getChqNb();
            strategy.appendField(locator, this, "chqNb", buffer, theChqNb, (this.chqNb!= null));
        }
        {
            NameAndAddress10 theChqFr;
            theChqFr = this.getChqFr();
            strategy.appendField(locator, this, "chqFr", buffer, theChqFr, (this.chqFr!= null));
        }
        {
            ChequeDeliveryMethod1Choice theDlvryMtd;
            theDlvryMtd = this.getDlvryMtd();
            strategy.appendField(locator, this, "dlvryMtd", buffer, theDlvryMtd, (this.dlvryMtd!= null));
        }
        {
            NameAndAddress10 theDlvrTo;
            theDlvrTo = this.getDlvrTo();
            strategy.appendField(locator, this, "dlvrTo", buffer, theDlvrTo, (this.dlvrTo!= null));
        }
        {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "chqMtrtyDt", buffer, theChqMtrtyDt, (this.chqMtrtyDt!= null));
        }
        {
            String theFrmsCd;
        ...
        {
            List<String> theMemoFld;
            theMemoFld = (((this.memoFld!= null)&&(!this.memoFld.isEmpty()))?this.getMemoFld():null);
            strategy.appendField(locator, this, "memoFld", buffer, theMemoFld, ((this.memoFld!= null)&&(!this.memoFld.isEmpty())));
        }
        {
            String theRgnlClrZone;
            theRgnlClrZone = this.getRgnlClrZone();
            strategy.appendField(locator, this, "rgnlClrZone", buffer, theRgnlClrZone, (this.rgnlClrZone!= null));
        }
        {
            String thePrtLctn;
            thePrtLctn = this.getPrtLctn();
            strategy.appendField(locator, this, "prtLctn", buffer, thePrtLctn, (this.prtLctn!= null));
        }
        {
            List<String> theSgntr;
            theSgntr = (((this.sgntr!= null)&&(!this.sgntr.isEmpty()))?this.getSgntr():null);
            strategy.appendField(locator, this, "sgntr", buffer, theSgntr, ((this.sgntr!= null)&&(!this.sgntr.isEmpty())));
        }
        return buffer;
    }
