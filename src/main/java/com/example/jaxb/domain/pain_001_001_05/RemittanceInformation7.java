...
public class RemittanceInformation7 implements ToString2
{
    ...
    public void setStrd(List<StructuredRemittanceInformation9> value) {
        this.strd = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            List<StructuredRemittanceInformation9> theStrd;
