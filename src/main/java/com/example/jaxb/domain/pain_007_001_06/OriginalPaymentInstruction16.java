...
public class OriginalPaymentInstruction16 implements ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            String theRvslPmtInfId;
            theRvslPmtInfId = this.getRvslPmtInfId();
            strategy.appendField(locator, this, "rvslPmtInfId", buffer, theRvslPmtInfId, (this.rvslPmtInfId!= null));
        }
        {
        ...
        {
            Boolean thePmtInfRvsl;
            thePmtInfRvsl = this.isPmtInfRvsl();
            strategy.appendField(locator, this, "pmtInfRvsl", buffer, thePmtInfRvsl, (this.pmtInfRvsl!= null));
        }
        {
        ...
        {
            List<PaymentTransaction64> theTxInf;
